      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
          ...
          <div className="space-y-6 sm:space-y-8">
            <div className="flex items-center gap-4 sm:gap-6 p-4 sm:p-6 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 animate-fade-in" style={{animationDelay: '0.1s'}}>
              <div className="bg-green-100 p-3 sm:p-4 rounded-full flex-shrink-0 transition-all duration-300 hover:scale-110">
            ...
            <div className="flex items-center gap-4 sm:gap-6 p-4 sm:p-6 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 animate-fade-in" style={{animationDelay: '0.2s'}}>
              <div className="bg-red-100 p-3 sm:p-4 rounded-full flex-shrink-0 transition-all duration-300 hover:scale-110">
            ...
            <div className="flex items-center gap-4 sm:gap-6 p-4 sm:p-6 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 animate-fade-in" style={{animationDelay: '0.3s'}}>
              <div className="bg-orange-100 p-3 sm:p-4 rounded-full flex-shrink-0 transition-all duration-300 hover:scale-110">
          ...
          {/* Contact Form */}
          <div className="bg-white rounded-2xl shadow-lg p-6 sm:p-8 animate-fade-in" style={{animationDelay: '0.4s'}}>
