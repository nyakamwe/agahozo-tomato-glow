        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-yellow-100 text-sm">+250 789 049 051</span>
              </div>
              <div className="flex items-center gap-3">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li className="text-yellow-100 text-sm hover:text-orange-300 transition-colors cursor-pointer">
        ...
        <div className="border-t border-yellow-500 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6 text-sm">
              <a href="#" className="text-yellow-200 hover:text-orange-300 transition-colors">
                Privacy Policy
              </a>
              <a href="#" className="text-yellow-200 hover:text-orange-300 transition-colors">
                Terms of Service
